...
<div class="container">
    <ul>
                    ...
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/Exercicio1.html">Exercício</a></li>
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/operacoes-ternarias.html">Operações ternárias</a></li>
                    ...
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/diferencas-entre-var,let-e-const.html">Diferenças entre var, let e const</a></li>
                    ...
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/Atribuicao-via-desestruturacao-Objetos.html">Atribuição via desestruturação - Objetos</a></li>
                    ...
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/Exercicio-com-NodeList.html">Exercício com NodeList</a></li> 
                    ...
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/Execicio com-logica-de-programacao-1.html">Execício com lógica de programação 1</a></li> 
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/Execicio com-logica-de-programacao-2.html">Execício com lógica de programação 2</a></li>
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/Execicio com-logica-de-programacao-3.html">Execício com lógica de programação 3</a></li>
                    ...
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/Exercicio-Criando-um-timer.html">Exercício - Criando um timer</a></li>
                    ...
                    <li><a class="basico" href="${diretorioArquivoConteudo}javascript/logica de programacao/Exercicio-Criando-uma-lista-de-tarefas.html">Exercício - Criando uma lista de tarefas</a></li>
